    ...
    <Card className="shadow-xl border-2 border-gray-200 overflow-hidden w-full lg:flex-1 h-137.5 flex flex-col">
      ...
      <CardContent className="flex min-h-0 flex-1 flex-col gap-2.5 p-4">
            ...
            <div className="absolute right-3 top-3 z-10 inline-flex items-center gap-1 rounded border border-zinc-300 bg-white px-1.5 py-1 shadow-xs">
              <label htmlFor="quiz-item-count" className="text-[10px] font-medium text-zinc-600">
                ...
                onChange={(e) => {
                  ...
                  className="w-10 rounded border border-zinc-300 bg-white px-1 py-0.5 text-center text-[11px] font-medium text-zinc-900 outline-none"
                />
              </div>
              <textarea
                id="quiz-input"
                ...
                className="premium-scrollbar h-32 w-full rounded-lg border-2 border-zinc-300 bg-white p-4 pt-10 text-sm resize-none focus:outline-none lg:h-36"
              />
        ...
        <div className="mt-auto space-y-2">
          ...
          {uploadedFile && <div className="text-xs text-zinc-600 truncate">File: {uploadedFile.name}</div>}
        </div>
